...
int main(){
    ...
    while(mulInv(k1) == -1)         // 1st key এর যদি multiplicative inverse না থাকে (-1 মানে নাই), তাহলে key গুলা আবারো input নেওয়া লাগবে
    {
        printf("k1 does not have multiplicative inverse. Enter Key values again:\n");
        scanf("%d %d",&k1, &k2); // যতক্ষণ ভুল key দেবে, ততক্ষণ input নিতে থাকবো
    }
